...
import { CheckCircle, Calculator, TrendingUp, PieChart, Activity, Box, ChevronDown, ChevronUp, ArrowLeft, FileText, HelpCircle, ChevronLeft } from 'lucide-react';

// --- DATABASE (محتوای آموزشی و سوالات اصلاح شده) ---
const topics = [
  {
    id: 'functions',
  ...
  return (
    <div className="p-6">
      ...
      <footer className="mt-10 text-center text-xs text-gray-400">
        ...
        <p className="mt-1 dir-ltr font-mono text-[10px] opacity-50">Version 1.1.0 | Math Fixes</p>
      </footer>
    </div>
  );
};
